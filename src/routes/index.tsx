...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: `${ACADEMY.name} | Snooker & Pool Academy` },
      {
        name: "description",
        content:
          "Six 12ft tournament snooker tables, two 9ft pool tables, in-house cafe, coaching and leagues. Book a table in seconds — no account needed.",
      },
      { property: "og:title", content: `${ACADEMY.name} | Snooker & Pool Academy` },
      {
        property: "og:description",
        content:
          "Tournament-grade snooker and pool, coaching, cafe and cue lockers. Book a table in seconds.",
      },
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Button asChild variant="outline" className="min-h-12 border-border bg-surface/70">
              <Link to="/services">See facilities</Link>
            </Button>
          </div>
